...
export default function ListPage() {
    ...
    const rows = listData
        ? listData.map((item) => createData(item.name, item.bought, item.price))
        : [];
    ...
    const fetch_list_data = async () => {
        try {
            ...
            if (list_id) {
                const res = await fetch(`${LISTS_API_URL}/listItems`, {
                    method: 'POST',
                    mode: 'cors',
                    headers: {
                        'Content-Type': 'application/json',
                            ...
                            <TableBody>
                                ...
                                >
                                    <TableCell padding="checkbox">
                                        <AddBoxIcon onClick={handleAddItem} />
                                    </TableCell>
                                    <TableCell
                                        component="th"
